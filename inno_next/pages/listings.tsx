...
export default function Listings() {
  ...
  return (
    <div className='min-h-screen md:px-32 bg-background md:py-10 relative'>
      <div className='bg-white flex flex-col top-0 z-50'>
        ...
        <div className='flex flex-row gap-10 pb-2 h-fit bg-background'>
            ...
            <div className='flex flex-row gap-10'>
              <div className='flex flex-col gap-4 w-full pt-4'>
                <div className='bg-white rounded-2xl p-2'>
                  <div className=' flex flex-col rounded-2xl p-2 space-y-5'>
                    {activeTab === 0 &&
          ...
          <div className='pt-4 w-1/4 sticky'>
                ...
                <div className='bg-gray-300/30 flex flex-col gap-3 rounded-2xl p-2'>
                  {NOTICE.map((notice) => (
                    <div className='flex flex-col shadow px-2 py-1 bg-white rounded-lg'>
                      ...
                      <div className='text-gray-500 text-sm'>{notice.description}</div>
                    </div>
                  ))}
                </div>
              </div>
